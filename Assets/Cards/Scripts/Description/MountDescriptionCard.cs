...
public class MountDescriptionCard : MonoBehaviour
{
    public void MountCard(Card cardSelected)
    {
        ...
        cardTemp.transform.GetChild(0).GetChild(1).GetComponent<Image>().sprite = cardSelected.GetCardArtwork();
        cardTemp.transform.GetChild(2).GetComponent<TextMeshProUGUI>().text = cardSelected.GetCardName();
        cardTemp.transform.GetChild(3).GetChild(1).GetComponent<TextMeshProUGUI>().text = cardSelected.GetCardCost().ToString();
        cardTemp.transform.GetChild(4).GetChild(1).GetComponent<TextMeshProUGUI>().text = cardSelected.GetCardEffectAmount().ToString();
